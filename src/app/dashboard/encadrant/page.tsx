  ...
  return (
    <div>
      ...
      <p className="mb-8 text-sm text-muted">
        Bienvenue sur votre espace encadrant. Consultez et validez ici les
        dossiers de vos doctorants.
      </p>

      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <StatCard label="Dossiers à valider" value="—" />
        <StatCard label="Validés" value="—" />
        <StatCard label="Corrections demandées" value="—" />
      </div>
      ...
      <div className="mt-8 rounded border border-border px-6 py-5">
        ...
        <p className="text-xs text-muted">
          Les dossiers soumis par vos doctorants apparaîtront ici.
        </p>
      </div>
    </div>
  )
